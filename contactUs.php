...
<html>
    ...
    <head>
        ...
        <title>Contact us - EventStay.com</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <img src="images/contactUs/shape.png" class="square" alt="" />
            ...
            <div class="form">
                <div class="contact-info">
                    ...
                    <div class="info">
                        <div class="information">
                            <img src="images/contactUs/location.png" class="icon" alt="" />
                            <p>26985 Brighton Lane, Lake Forest, CA 92630</p>
                        </div>
                                <div class="information">
                                    <img src="images/contactUs/email.png" class="icon" alt="" />
                                    <p>John@sajadhesami.com</p>
                                </div>
                                <div class="information">
                                    <img src="images/contactUs/phone.png" class="icon" alt="" />
                                    <p>+30-2106019311</p>
                                </div>
                            </div>
                        ...
                        <div class="contact-form">
                            ...
                            <form action="contactUsprocess.php" method="post" autocomplete="off">
                                ...
                                <div class="input-container">
                                    <input type="tel" pattern="[o-9]{10}" name="phone" class="input" />
                ...
                if(isset($_SESSION['user_name'])){
                    ...
                    $sql = "SELECT * FROM contact_us WHERE C_User_Email = '$email' ";
                    ...
                    if($result->num_rows > 0) {
                        ...
                        while($result2 = $result-> fetch_assoc())
                        {
                            ...
                            <td>'.$result2["User_Name"].'</td>
                            </tr>
                            <tr>
                            <td>Email</td>
                            <td>'.$result2["C_User_Email"].'</td>
                            </tr>
                            </tr>
                            <tr>
                            <td>Phone Number</td>
                            <td>'.$result2["Phone_Num"].'</td>
                            </tr>
                            </tr>
                            <tr>
                            <td>Message</td>
                            <td>'.$result2["User_Message"].'</td>
                            </table><br>';
                        }
                        
                        echo '<a href="deleteContactUs.php" class="btn_type1">Delete</a>';
