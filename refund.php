...
<head>
    ...
    <title>Refund</title>
    <link rel="stylesheet" href="style/style_refund.css">
...
<!--end-->
  ...
  <div class="container">
        ...
        <form action="refundProcess.php" method="post">
            <h3>Fill Your Bank Details</h3>
            <div class="form-group">
                <label for="account-holder-name">Account Holder Name</label>
                <input type="text" id="account-holder-name" name="acc_hold_name" placeholder="Enter account holder name" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="branch-name" name="branch_name" placeholder="Enter branch name" required>
            </div>
            <div class="form-group">
                <label for="account-number">Account Number</label>
                <input type="text" id="account-number" name="acc_no" placeholder="Enter account number" required>
            </div>
            <input type="submit" value="Request Refund" name="submitRefund">
        </form>
  </div>
